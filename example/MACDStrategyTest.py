...
4. CSV file analysis for signal validvalidationation
validation
Features:
...
from src.utils import determine_trade_result
...
async def get_candles(ssid, asset, action, need_restart = True):
    ...
    try:
        ...
        return await process_candle_data_async(candles, current_asset)
...
async def process_candle_data_async(candles: list, current_asset: str):
    """
