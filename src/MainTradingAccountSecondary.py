...
# Constants
SESSION_NAME = 'MainTradingAccountSecondary'

class MainTradingAccountSecondary():
    def __init__(self):
...
def main():
    ...
    try:
        bot = MainTradingAccountSecondary()
        asyncio.run(bot.start())
    except Exception as e:
        traceback_exception = traceback.format_exc()
        logging.error(f"MainTradingAccountSecondary initialization failed: {e}", traceback_exception)
