...
# Constants
SESSION_NAME = 'MainTradingAccountPrimaryDemo'

class MainTradingAccountPrimaryDemo():
    def __init__(self):
...
def main():
    ...
    try:
        bot = MainTradingAccountPrimaryDemo()
        asyncio.run(bot.start())
    except Exception as e:
        traceback_exception = traceback.format_exc()
        logging.error(f"MainTradingAccountPrimaryDemo initialization failed: {e}", traceback_exception)
